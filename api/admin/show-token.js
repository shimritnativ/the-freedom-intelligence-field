...
//        https://thefieldai.app/api/admin/show-token
...
<body>
  ...
  <p>One-off recovery tool. After you copy the value, delete <code>/api/admin/show-token.js</code> from the repo and redeploy.</p>
  ...
  <script>
    (async function() {
      ...
      try {
        const r = await fetch('/api/admin/show-token', {
          method: 'POST',
  ...
  return res.status(200).json({
    ok: true,
    warning: "DELETE /api/admin/show-token.js AFTER COPYING",
