...
export const REMINDER_COPY = {
  day2_unlocked: {
    title: "Day 2 is open ✨",
    body: "Your Day 1 work is done. Day 2 — Decision & Action — is ready when you are.",
  },
  day2_nudge: {
  ...
  day3_unlocked: {
    title: "Day 3 is open ✨",
    body: "The peak of your Reset. Today the Field takes you into Frequency Calibration — living inside the frequency of what you decided.",
  },
  day3_nudge: {
    title: "Day 3 is waiting",
    body: "Frequency Calibration is the last piece. Show up today.",
  },
  window_closing: {
