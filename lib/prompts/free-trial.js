...
The marker is a signal to the system to NOT count this exchange against the four-exchange budget. The participant keeps all their remaining exchanges intact.
...
If in doubt, treat it as an answer, not a clarification.

Never use [[CLARIFY]] on the FINAL exchange's closing line. Clarifications only apply to earlier questions.
