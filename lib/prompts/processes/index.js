...
import { BODY_INTELLIGENCE_SYSTEM_PROMPT } from "./body-intelligence.js";
...
import { WORKOUT_AMPLIFIER_SYSTEM_PROMPT } from "./workout-amplifier.js";
import { WORTHY_TO_RECEIVE_SYSTEM_PROMPT } from "./worthy-to-receive.js";
import {
  WORKSHOP_INTEGRATION_1_SYSTEM_PROMPT,
  WORKSHOP_INTEGRATION_2_SYSTEM_PROMPT,
  WORKSHOP_INTEGRATION_3_SYSTEM_PROMPT,
} from "./workshop-integration.js";
...
export const PROCESSES = [
  ...
  { key: "body-intelligence", displayName: "Body Intelligence",
    descriptor: "Listen to what your body is communicating. Read the sensation. Send it what it needs.",
    activationPhrase: "i am entering body intelligence",
    prompt: BODY_INTELLIGENCE_SYSTEM_PROMPT },
  ...
  { key: "workout-amplifier", displayName: "Workout Amplifier",
    descriptor: "Turn your workout into a charging session. I AM statements fired in every interval.",
    activationPhrase: "i am entering the workout amplifier",
    prompt: WORKOUT_AMPLIFIER_SYSTEM_PROMPT },
  ...
  // Workshop VIP integration processes. Placeholder prompts for now,
  // swapped for real content before September 21, 2026.
  { key: "workshop-integration-1", displayName: "Integration Work · Day 1",
    descriptor: "Anchor what opened on Day 1 of the workshop into your instrument.",
    activationPhrase: "i am entering the workshop integration work for day 1",
    prompt: WORKSHOP_INTEGRATION_1_SYSTEM_PROMPT },
  { key: "workshop-integration-2", displayName: "Integration Work · Day 2",
    descriptor: "Integrate Day 2's teaching through guided reflection with the Field.",
    activationPhrase: "i am entering the workshop integration work for day 2",
    prompt: WORKSHOP_INTEGRATION_2_SYSTEM_PROMPT },
  { key: "workshop-integration-3", displayName: "Integration Work · Day 3",
    descriptor: "Close the loop from the workshop and calibrate for what comes next.",
    activationPhrase: "i am entering the workshop integration work for day 3",
    prompt: WORKSHOP_INTEGRATION_3_SYSTEM_PROMPT },
];
