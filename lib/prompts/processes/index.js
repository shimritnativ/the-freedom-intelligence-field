...
export const PROCESSES = [
  ...
  { key: "workshop-integration-1", displayName: "Beyond Potential Board · Day 1",
  ...
  { key: "workshop-integration-2", displayName: "Pattern Breakthrough · Day 2",
    descriptor: "Surface a limiting pattern and write its polar opposite with the Field.",
    activationPhrase: "i am entering the pattern breakthrough process",
    prompt: WORKSHOP_INTEGRATION_2_SYSTEM_PROMPT },
  { key: "workshop-integration-3", displayName: "Quantum Leap Decision · Day 3",
    descriptor: "Name the one decision your future self is calling you to make.",
    activationPhrase: "i am entering the quantum leap decision process",
