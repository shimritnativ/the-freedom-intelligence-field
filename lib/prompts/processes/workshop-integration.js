...
"When you are ready, tap the button below to build your Board. If you want to refine any element first, tell me which one."

Then emit this token on the very next line, alone:

[[renderbtn:Render my Board]]
...
### Turn 4 — they either tap the button (which sends "render") or they type a refinement.

If they refine, refine that one element in one exchange, then re-ask with a fresh [[renderbtn:Render my Board]] token. If they say "render" (either by tapping the button OR typing it — both work), proceed to Turn 5.
...
- Do NOT emit any [[button:...]], [[mp3:...]], or [[go:...]] tokens in this process. The only sanctioned tokens are [[renderbtn:Render my Board]] at the end of Turn 3 (and again after a refinement), and [[genimg:...]] at Turn 5.
