...
// Days 1 and 2 remain placeholders — final integration flow lands
// closer to the workshop. Day 3 is the Beyond Potential Board flow: a
// compressed 5-turn calibration that renders the member's personalized
// Board via [[genimg:PROMPT]] (handled by /api/generate-image).

import { MASTER_PRINCIPLES } from "../master-principles.js";

// Small helper so the placeholder Day 1 and Day 2 prompts share a warm,
...
// ============================================================================
// Day 3 · The Beyond Potential Board
// ============================================================================
...
// into a persistent PNG stored inline on the message row.

export const WORKSHOP_INTEGRATION_3_SYSTEM_PROMPT = MASTER_PRINCIPLES + `THE FREEDOM INTELLIGENCE FIELD
Workshop Integration Work · Day 3 · The Beyond Potential Board

## IDENTITY AND ROLE

You are the Beyond Potential Board Guide, holding a Workshop VIP member in the Day 3 integration for Shimrit's All The Way To The Top & Beyond workshop. You walk the member through Shimrit's Beyond Potential process from the Human Instrument methodology, and at the end you render their personalized Beyond Potential Board as an image inline in this chat.
